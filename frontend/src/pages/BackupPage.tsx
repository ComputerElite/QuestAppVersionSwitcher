...
const [selectedBackup, setSelectedBackup] = createSignal<IBackup | undefined>(
  undefined,
);
  ...
  return (
    <ListItem
      sx={{
        ...
        padding: "15px 20px",
        backgroundColor:
          selectedBackup()?.backupName == props.backup.backupName
            ? "#333"
            : "#222",
        justifyContent: "space-between",
        background: "#111827",
    ...
    >
      <Box>
        ...
        >
          <span>{props.backup.backupName}</span>
          <span
            style={{
              "font-size": "12px",
              "margin-left": "5px",
      ...
      >
        <IconButton
          color="info"
          onClick={() =>
            props.onRestoreClick != null && props?.onRestoreClick(props.backup)
          }
        >
          <RestoreIcon />
        </IconButton>
        <IconButton
          color="error"
          onClick={() =>
            props.onDeleteClick != null && props?.onDeleteClick(props.backup)
          }
        >
          <FiTrash />
        </IconButton>
