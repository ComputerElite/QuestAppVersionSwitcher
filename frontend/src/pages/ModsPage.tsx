    ...
    () => {
      ...
      return {
        mods: allMods
          ...
          .sort((a, b) => CompareStringsAlphabetically(a.Name, b.Name)),
        libs: allMods
          ?.filter((s) => s.IsLibrary)
          .sort((a, b) => CompareStringsAlphabetically(a.Name, b.Name)),
      };
  ...
  return (
    <PageLayout>
      ...
      <div class=" contentItem modsPage">
        ...
        >
          <Index
            each={filteredData()?.libs}
            fallback={<div class="emptyText">No mods</div>}
          >
            {(mod) => <ModCard mod={mod()} />}
          </Index>
        </List>
      ...
      <GetMoreMods
        onClose={() => {
          setShowGetMoreMods(false);
        }}
        open={showGetMoreMods()}
      />
    </PageLayout>
  );
}
    ...
    >
      ...
      >
        ...
        >
          ...
          <Typography
            ...
            class="text-accent"
          >
            v{mod.VersionString} {mod.Author ? `by ${mod.Author}` : ""}
          </Typography>
        </Box>
        <Typography
          sx={{
      ...
      >
        ...
        <Switch
          ...
          onChange={() => ToggleModState(mod.Id, !mod.IsInstalled)}
        />
      </Box>
    </ListItem>
  );
