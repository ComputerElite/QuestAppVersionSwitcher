...
export function DoneStep(props: {
  ...
  return (
          ...
          <RunButton
            ...
            onClick={async () => {
              let sure = await showConfirmModal({
                title: "Start game",
                message:
                  "Are you sure you want to start the game without installing mods? Patched game with no mods does not make sense if you are not a developer.",
              });
    ...
    >
      ...
      <Show when={!props.customMessage}>
        <SmallText>
          The game is successfully installed, you can now start the game or
          install the mods.
        </SmallText>
      </Show>
    </CustomModal>
