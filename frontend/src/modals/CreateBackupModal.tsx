  ...
  return (
    <>
      <Show when={done()}>
        ...
        <Show when={error()}>
          <MediumText>Failed to create backup</MediumText>
        </Show>
      ...
      <Show when={!done() || error()}>
        <pre
          ref={logElement}
          class="bg-black text-white p-2 rounded-none max-w-xs h-28 overflow-y-auto text-sm "
        >
