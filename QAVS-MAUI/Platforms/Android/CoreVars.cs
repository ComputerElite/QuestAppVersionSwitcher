...
namespace QuestAppVersionSwitcher.Core
{
    ...
    public class CoreVars : StrippedConfig // aka config
    {
        ...
        public readonly string QAVSTmpPatchingObbDir = Android.OS.Environment.ExternalStorageDirectory.AbsolutePath +
                                                       "/QuestAppVersionSwitcher/tmpPatching/obb/";
        ...
        public readonly string QAVSADBDir = Android.OS.Environment.ExternalStorageDirectory.AbsolutePath + "/Android/data/com.ComputerElite.questappversionswitcher/";
